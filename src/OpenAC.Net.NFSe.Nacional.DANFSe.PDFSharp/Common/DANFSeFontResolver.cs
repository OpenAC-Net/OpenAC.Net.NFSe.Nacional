...
/// Fornece fontes TrueType (LiberationSans - métrica compatível com Arial) embutidas como recursos do assembly,
/// garantindo funcionamento imediato em Docker, Alpine Linux, distroless, Windows, macOS e ambientes sem fontes instaladas.
/// </summary>
public sealed class DANFSeFontResolver : IFontResolver
{
    ...
    private const string ResourcePrefix = "OpenAC.Net.NFSe.Nacional.DANFSe.PDFSharp.Resources.Fonts.";
    ...
    /// <summary>
    /// Resolve o tipo de fonte solicitado (Arial, Helvetica, LiberationSans, etc.) para os recursos embutidos.
    /// </summary>
